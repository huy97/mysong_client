        ...
        >
          ...
          >
            ...
            <p className="ant-upload-text">
              Kéo thả tệp hoặc bấm vào đây để tải lên
            </p>
          </Dragger>
          {medias.length ? (
            <div className={styles.form}>
              ...
              >
                {thumbnailData ? (
                  ...
                  <div>
                    {isUploadThumbnail ? (
                      <Spin indicator={<LoadingOutlined size={32} />} />
                    ) : (
                      <FiUpload size={32} />
                    )}
                  </div>
                  ...
                  >
                    <Select mode="multiple" placeholder="Chọn nghệ sĩ">
                      {artists.map((artist, key) => (
                        <Select.Option key={key} value={artist._id}>
                          {artist.fullName}
                        </Select.Option>
                      ))}
                    </Select>
                  ...
                  >
                    <Select mode="multiple" placeholder="Chọn thể loại">
                      {categories.map((category, key) => (
                        <Select.Option key={key} value={category._id}>
                          {category.title}
                        </Select.Option>
                      ))}
                    </Select>
