        ...
        try {
            ...
            let data = {
                ...
                lyrics: lyrics.filter(
                    (obj, index) => index >= this.state.lyrics.length
                ),
                zone,
                status,
                categories,
                ...
                mediaIds: medias
                    .filter(
                        (media) => media.media.mediaType !== MEDIA_TYPE.IMAGE
                    )
    ...
    componentDidUpdate = async (prevProps, prevState, snapshot) => {
        if (snapshot.isEdit) {
            let initData = {
                ...
                lyrics: snapshot.editData.lyrics.map((obj) => obj.content),
                        ...
                        >
                            ...
                            <Form.Item name="status" label="Trạng thái">
                                <Select placeholder="Chọn trạng thái">
                                    <Select.Option value={SONG_STATUS.ACTIVE}>
                                        Đang hoạt động
                                    </Select.Option>
                                    <Select.Option value={SONG_STATUS.PRIVATE}>
                                        Riêng tư
                                    </Select.Option>
                                    <Select.Option value={SONG_STATUS.PENDING}>
                                        Chờ duyệt
                                    </Select.Option>
                                </Select>
                            </Form.Item>
